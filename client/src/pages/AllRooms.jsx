    ...
    <div className=" flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24">
      <div>
        <div className="flex flex-col items-start text-left">
          <h1 className="font-playfair text-4xl md:text-[40xl]">Hotel Rooms</h1>
        ...
        {roomsDummyData.map((room) => (
          <div
            ...
            key={room._id}
            className=" cursor-pointer flex flex-col md:flex-row items-start py-10  gap-6 border-b border-gray-300 last:pb-30 last:border-0"
          >
            <img
              src={room.images[0]}
              alt="hotel-image"
            ...
            <div className="md:w-1/2 flex flex-col gap-2 ">
              ...
              <p
                ...
                className=" font-playfair text-3xl text-gray-800 "
              >
                {room.hotel.name}
              </p>
      ...
      {/* Filters */}
      <div className="bg-white w-80 border border text-gray-600 max-lg:mb-8 min-lg:mt-16">
        <div
